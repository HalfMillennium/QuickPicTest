...
public class ServerConstants {
    ...
    // GitHub URLs
    public static final String GITHUB_LEAFPIC = "https://github.com/HoraApps/QuickPic";
    ...
    // QuickPic URLs
    public static final String LEAFPIC_ISSUES = "https://github.com/HoraApps/QuickPic/issues";
    public static final String LEAFPIC_CROWDIN = "https://crowdin.com/project/leafpic";
    public static final String LEAFPIC_LICENSE = "https://github.com/HoraApps/QuickPic/blob/master/LICENSE";
    public static final String LEAFPIC_CHANGELOG = "https://github.com/HoraApps/QuickPic/blob/dev/CHANGELOG.md";
